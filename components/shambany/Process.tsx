...
//             </h2>
//           </div>
//           <p className="text-teal-900/50 text-md md:text-right text-lg leading-relaxed max-w-sm ">
...
//                     </span>
//                   </div>
//                   <div className="w-12 h-12 rounded-[2rem] flex items-center justify-center border border-white/15"
    ...
    <section id="how-it-works" className="bg-white py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 mb-20">
          ...
          <p className="text-teal-900/50 md:text-right text-lg leading-relaxed max-w-sm">
            Three intelligent steps that transform how your farm operates every single day.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 items-stretch">
          ...
          {steps.map(({ n, icon: Icon, title, body, tag, color, accent }) => (
            <div key={n} className="relative group h-full">

              {/* Card */}
              <div
                className={`bg-linear-to-br ${color} overflow-hidden h-full flex flex-col`}
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle at 80% 20%, ${accent}14 0%, transparent 55%)`,
                  }}
                />
                ...
                <div className="relative z-10 px-8 pt-8 pb-6 flex items-start justify-between">
                  <div>
                    <span
                      className="block text-[0.65rem] font-bold uppercase tracking-[0.25em] mb-1"
                      style={{ color: `${accent}99` }}
                    >
                      Step
                    </span>
                    ...
                    <span
                      className="font-bold text-white/20 leading-none select-none"
                      style={{
                        fontFamily: 'Georgia, serif',
                        fontSize: '4.5rem',
                        lineHeight: 1,
                  ...
                  <div
                    className="w-12 h-12 rounded-[2rem] flex items-center justify-center border border-white/15"
                    style={{ background: `${accent}20` }}
                  >
                    <Icon size={22} strokeWidth={1.6} style={{ color: accent }} />
                  </div>
                ...
                {/* Content */}
                <div className="relative z-10 px-8 pb-10 flex flex-col flex-1">
                  <h3
                  ...
                  <p className="text-white/60 text-md leading-relaxed flex-1">
                    {body}
                  </p>
                </div>
