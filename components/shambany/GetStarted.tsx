    ...
    <>
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="absolute inset-0"
          style={{ background: 'linear-gradient(135deg, rgba(2,44,36,0.7) 0%, transparent 70%)' }} />
        

        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="w-8 h-px bg-green-500" />
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-green-400">Our Customer Promise</span>
            <div className="w-8 h-px bg-green-500" />
          </div>

          <p className="text-white font-bold leading-relaxed"
            style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.5rem, 3vw, 2.4rem)' }}>
            At Shambani, we empower farm managers and farm owners with{' '}
            <span className="text-green-400 ">smart technology</span> and professional services
            to make every farm operation{' '}
            <span style={{
          ...
          <div className="grid lg:grid-cols-[1fr_1.1fr] gap-16 items-start">
            ...
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="text-sm font-bold uppercase tracking-[0.2em] text-green-600">Get Started</span>
              </div>

              <h2 className="font-bold text-teal-900 leading-tight mb-6"
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={p} className="flex items-center gap-3.5 py-3 border-b border-gray-100">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange} required placeholder="Jane Wanjiru"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange} required placeholder="jane@yourfarm.co.ke"
                          className="w-full px-4 py-3.5 text-sm border border-gray-200 rounded-[0.5rem] text-teal-900 placeholder-teal-900/25 bg-gray-50 focus:bg-white focus:outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-400/12 transition-all"
                        />
                      </div>
